...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/django-pwa-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11954&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/django-pwa-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `django-pwa` can be installed with:

```
conda install django-pwa
```

It is possible to list all of the versions of `django-pwa` available on your platform with:
